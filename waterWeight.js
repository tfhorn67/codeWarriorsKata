...
//solution
function potatoes(initialWaterRatio, initialWeight, finalWaterRatio) {
    // your code
    let dryWeight = initialWeight * ((100 - initialWaterRatio)/100)
    let finalWeight = (dryWeight * 100)/(100-finalWaterRatio)
