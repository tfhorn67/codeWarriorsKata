...
if (arr === []) return b
//this one has me head scratching for a non brute force option
//create array to represent cups: cups = [1, 2, 3]
  let cups = [1,2,3]
//loop through arr and alter cup arr to match swaps
  arr.forEach((element) => {
    let temp = cups[element[0]-1]
    cups[element[0]-1] = cups[element[1]-1]
    cups[element[1]-1] = temp
  })
//return indexOf(b)
